...
export function Sidebar({ user, onLogout, isOpen = true, onClose }: SidebarProps) {
            ...
            <div className="h-16 flex items-center px-3 border-b border-border-light dark:border-border-dark">
                ...
                <div
                    className={cn(
                        ...
                        expanded ? 'opacity-100 w-auto' : 'w-auto opacity-100 lg:opacity-0 lg:w-0'
                    )}
                >
                ...
                {navItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {!expanded && (
                                <span className="hidden lg:block absolute left-full ml-2 px-2 py-1 text-xs rounded-md bg-gray-900 text-white dark:bg-gray-100 dark:text-gray-900 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 whitespace-nowrap pointer-events-none">
                                    {item.label}
                                </span>
                            )}
                        </Link>
